...
/// <c>[MauiHelpers.Mvvm.ObservableProperty]</c> attribute.
/// </summary>
/// <remarks>This source generator scans for properties in classes that are annotated with the 
/// <c>[MauiHelpers.Mvvm.ObservableProperty]</c> attribute and generates code to implement  observable property
		...
		var properties = context.SyntaxProvider
			.CreateSyntaxProvider(
				...
				transform: static (ctx, _) =>
				{
					...
					{
						if (attr.AttributeClass?.Name == "MauiHelpers.Mvvm.ObservablePropertyAttribute" ||
							attr.AttributeClass?.ToDisplayString() == "MauiHelpers.Mvvm.ObservablePropertyAttribute")
						{
							hasAttribute = true;
							break;
						}
